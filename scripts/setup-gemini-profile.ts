...
const executablePath: string | undefined = process.env["WEB2API_GEMINI_EXECUTABLE"] ?? defaultExecutablePath;

if (executablePath === undefined) {
  throw new Error("WEB2API_GEMINI_EXECUTABLE is required outside macOS");
}
...
chrome.unref();
process.stdout.write(`Gemini profile opened in Google Chrome: ${profileDirectory}\n`);
